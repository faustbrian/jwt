...
final class RFC6978VectorTest extends TestCase
{
     ...
     */
    #[Test()]
    #[DataProvider('provideThe_vectors_from_rf_c6978_can_be_verifiedCases')]
    public function the_vectors_from_rf_c6978_can_be_verified(
        AbstractEcdsaSigner $signer,
        KeyInterface $key,
        string $payload,
        string $expectedR,
        string $expectedS,
     ...
     * @return array<mixed>
     */
    public static function provideThe_vectors_from_rf_c6978_can_be_verifiedCases(): iterable
    {
